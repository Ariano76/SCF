    ...
    <div class="card-body">      
      ...
      <div class="row">        
        ...
        <div class="col-md-3" aria-label="Basic example">
          <button class="btn btn-success btn-lg" onclick="CargarDatosGraficoBarParametro('SP_reporte_05_viajan_con_menores')">Graficar datos</button>
        </div>
        <div class="col-md-3" aria-label="Basic example">
          <button class="btn btn-success btn-lg" onclick="CargarDatosTabla('SP_reporte_05_viajan_con_menores')">Datos en Tabla</button>
        </div>        
      </div>         
      <div class="row">
