  ...
  if (in_array($_FILES["file"]["type"], $allowedFileType)) {
    ...
    for ($i = 1; $i < $sheetCount; $i ++) {
      ...
      if (
        ...
        $query = "insert into stage_jetperu(dato_01, dato_02, dato_03, dato_04, dato_05, dato_06, dato_07, dato_08, dato_09, dato_10, dato_11, dato_12, dato_13, dato_14, dato_15, dato_16, dato_17, dato_18, dato_19) values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
