...
//if (isset($_POST['id'])) {
  ...
  foreach($usuarios as $usuario) {
    ...
    $sheet->setCellValue("AG".$i, $usuario[31]);
    $sheet->setCellValue("AH".$i, $usuario[32]);
    $sheet->setCellValue("AI".$i, $usuario[33]);
    $sheet->setCellValue("AJ".$i, $usuario[34]);
    $sheet->setCellValue("AK".$i, $usuario[35]);
    $sheet->setCellValue("AL".$i, $usuario[36]);
    $sheet->setCellValue("AM".$i, $usuario[37]);
    $sheet->setCellValue("AN".$i, $usuario[38]);
